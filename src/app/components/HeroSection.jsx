    ...
    shadow-2xl shadow-black/40 border border-neutral-800/30">
      ...
      order-2 lg:order-1">
          ...
          <p className="text-neutral-400 mb-4 lg:mb-6 text-sm lg:text-base relative z-20">
            StudentArt-Anime adalah situs anime gratis tanpa iklan untuk menonton anime gratis
          </p>
          <SearchInput />
          ...
          <div className="flex flex-col lg:flex-row space-y-3 lg:space-y-0 lg:space-x-4 relative z-20">
            ...
            <Link href={'http://localhost:3000/donate'} target='_blank' className="bg-blue-500 text-center text-white px-6 py-2 lg:py-3 rounded-full">
              Donate StudentArt-Anime
            </Link>
          </div>
        </div>
