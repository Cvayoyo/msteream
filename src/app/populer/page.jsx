...
async function getPopularAnime(page = 1) {
    try {
        ...
        const response = await fetch(`${apiUrl}/popular?page=${page}`, {
            cache: 'no-store'
        });
        ...
        console.error("Gagal mengambil data anime populer:", error);
...
const Page = async ({ searchParams: searchParamsPromise }) => {
    ...
    return (
        <>
            ...
            <div id="popular-content" className="min-h-screen bg-[#1A1A29] text-white p-4 md:p-8">
